...
const ReviewComment = ({ setIsAuthenticated }) => {
  ...
  const [sampleTasks, setSampleTasks] = useState([
    ...
    },
    {
      ...
      task: "Summarization",
      input:
        "The sun rises in the east and sets in the west. It provides light and warmth to Earth throughout the day.",
      output:
        "The sun rises in the east and sets in the west, providing light and warmth.",
    },
    {
      taskId: 4,
      task: "Summarization",
      input:
        "This comprehensive document describes the detailed steps required to construct a treehouse, including material selection, safety considerations, and construction techniques.",
      output:
        "A guide on building a treehouse covering materials, safety, and construction.",
    },
  ]);
  ...
  const handleExport = () => {
    const jsonBlob = new Blob([JSON.stringify(comments, null, 2)], {
      ...
      {selectedTask && (
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          <h2 className="text-xl font-semibold mb-4">
            Review Task {selectedTask.taskId}
          </h2>
